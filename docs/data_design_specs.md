...
Complete physical star schema — five dimensions, four facts, and their foreign-key relationships:

![Physical star schema — dimensions, facts, and foreign keys](../public/star_schema.png)
...
Source tables feed one analytical view per dashboard; each view fixes its grain and pre-computes its KPIs:
